...
extern bool ignore_errors_by_subsys_modem_restart; // seungyeol.seo, workaround fix for modem reset
...
int subsys_modem_restart()
{
	...
	ignore_errors_by_subsys_modem_restart = true; // seungyeol.seo, workaround fix for modem reset
